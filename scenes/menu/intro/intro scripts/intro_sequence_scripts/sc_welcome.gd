...
const CROWD_A = preload("res://assets/sprites/intro_scene/intro_sequence/welcome/crowdpeople_a.png") 
const CROWD_B = preload("res://assets/sprites/intro_scene/intro_sequence/welcome/crowdpeople_b.png") 
const CROWD_C = preload("res://assets/sprites/intro_scene/intro_sequence/welcome/crowdpeople_c.png")
