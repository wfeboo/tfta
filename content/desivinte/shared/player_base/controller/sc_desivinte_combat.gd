...
const MELEE_SCENE: PackedScene = preload("res://content/desivinte/shared/player_base/colosseum/melee/scenes/scn_desivinte_melee.tscn")
const AIRBORNE_SCENE: PackedScene = preload("res://content/desivinte/shared/player_base/colosseum/airborne/scenes/scn_desivinte_airborne.tscn")
