...
var ROOTS: Array[PackedScene] = [
	preload("res://content/game_intro/destiny_scene/roots/scenes/scn_roots_a.tscn"),
	preload("res://content/game_intro/destiny_scene/roots/scenes/scn_roots_b.tscn"),
	preload("res://content/game_intro/destiny_scene/roots/scenes/scn_roots_c.tscn")
]
