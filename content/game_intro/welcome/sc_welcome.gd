...
const CROWD_B: Texture2D = preload("res://assets/sprites/intro_scene/intro_sequence/welcome/placeholder/crowdpeople_b.png")
const CROWD_C: Texture2D = preload("res://assets/sprites/intro_scene/intro_sequence/welcome/placeholder/crowdpeople_c.png")
